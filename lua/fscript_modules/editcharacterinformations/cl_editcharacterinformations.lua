net.Receive("FScript.EditCharacterInformations.OpenMenu", function()
	...
	Title:SetText(FScript.Lang.EditCharacterInformationsTitle)
	...
	SubTitle:SetText(FScript.Lang.EditCharacterInformationsSubTitle)
	...
	ConfirmButton:SetText(FScript.Lang.EditCharacterInformationsValidation)
